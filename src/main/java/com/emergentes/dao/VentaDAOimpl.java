...
import com.emergentes.utiles.ConecionDB;
...
public class VentaDAOimpl  extends ConecionDB implements VentaDAO{
    ...
    public List<Venta> getAll() throws Exception {
        ...
        try {
            ...
            sql +="LEFT JOIN productos p ON v.producto_id ";
            sql +="LEFT JOIN clientes c ON v.cliente_id ";
